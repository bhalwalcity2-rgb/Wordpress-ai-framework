 ...
 *
 * About page — same full layout as the homepage with about-specific
...
<main id="lvjcb-main">
	...
	<?php get_template_part( 'template-parts/sections/cta-banner', null, lvjcb_get_cta_banner_args( 'about-mid', 'mid_page' ) ); ?>
	...
	<?php get_template_part( 'template-parts/sections/cta-banner', null, lvjcb_get_cta_banner_args( 'about-late', 'late_page' ) ); ?>
