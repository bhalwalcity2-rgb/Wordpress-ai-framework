 ...
 *
 * The parent page for every individual service page — same full
 * layout as the homepage.
 *
 * @package LVJCB
 */
...
<main id="lvjcb-main">
	...
	<?php get_template_part( 'template-parts/components/hero', null, array(
		'heading'     => "Cash for Junk Cars \u{2014}in Las Vegas, Any Condition",
	...
	<?php get_template_part( 'template-parts/sections/cta-banner', null, lvjcb_get_cta_banner_args( 'services-hub-mid', 'mid_page' ) ); ?>
	...
	<?php get_template_part( 'template-parts/sections/cta-banner', null, lvjcb_get_cta_banner_args( 'services-hub-late', 'late_page' ) ); ?>
