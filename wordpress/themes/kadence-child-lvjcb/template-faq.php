 ...
 *
 * FAQ page — same full layout as the homepage.
 *
 * @package LVJCB
 */
...
<main id="lvjcb-main">
	...
	<?php get_template_part( 'template-parts/components/hero', null, array(
		'heading'     => $faq['heading'],
		'description' => 'Everything you need to know before selling your junk car.',
	...
	<?php get_template_part( 'template-parts/sections/cta-banner', null, lvjcb_get_cta_banner_args( 'faq-mid', 'mid_page' ) ); ?>
