<?php
/**
 * "Why Choose Us" section. Assembles Component 08 (Why Choose Us Card).
 *
 * @param array $args {
 ...
 *     @type array  $cards   List of card data passed directly to why-choose-card.php.
 * }
 */
...
if ( '' === $section_id ) {
	$section_id = wp_unique_id( 'why-choose-us-' );
}
...
$intro   = $args['intro'] ?? '';
?>
<section class="lvjcb-section lvjcb-section--centered lvjcb-why-choose-us" aria-labelledby="<?php echo esc_attr( $heading_id ); ?>">
	<div class="lvjcb-section__container">
		...
		<div class="lvjcb-section__grid lvjcb-section__grid--4up">
			<?php foreach ( $cards as $card ) : ?>
				<?php get_template_part( 'template-parts/components/why-choose-card', null, $card ); ?>
			<?php endforeach; ?>
		</div>
